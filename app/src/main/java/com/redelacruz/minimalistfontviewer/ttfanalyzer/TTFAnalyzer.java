/*
 * Modified for Minimalist Font Viewer
 * Copyright (C) 2017 Robert Ernest dela Cruz
 *
 * Original:
 * Source:  https://github.com/1gravity/Android-RTEditor/blob/master/RTEditor/src/main/java/com
 *          /onegravity/rteditor/fonts/TTFAnalyzer.java
 *
...
public class TTFAnalyzer {
    ...
    //TODO: Maybe? Deeper analysis of TTF/OTF tables for other features

    private static final String TAG = "TTFAnalyzer";
    ...
    public static String getFontName(String filePath) {
        TTFRandomAccessFile in;
        try {
            Log.d(TAG, "Inside getFontName");
            //TODO: Add way of getting random r/w access for API >= 21
            RandomAccessFile file = new RandomAccessFile(filePath, "r");
            Log.d(TAG, "We get here");
            in = new TTFRandomAccessFile(file);
            Log.d(TAG, "We get here");

            return getTtfFontName(in);
        } catch (IOException e) {
            Log.d(TAG, "Error: " + e);
    ...
    private static String getTtfFontName(TTFInputStream in) {
        try {
            ...
            Log.d(TAG, "Inside getTtfFontName");
